## tsuru unit autoscale set

DEPRECATED: For better usability, this command has been replaced by "tsuru autoscale set".
...
```
tsuru unit autoscale set [-a/--app appname] [-p/--process processname] [--cpu targetCPU] [--min minUnits] [--max maxUnits] [--schedule scheduleWindow] [--prometheus prometheusSettings] [flags]
```
